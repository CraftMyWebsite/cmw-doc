...
**FICHIERS** : [Lien de la doc pour les fichier](https://craftmywebsite.fr/docs/fr/technical/conventions/fichiers)

**i18n**: [Lien de la doc i18n](https://craftmywebsite.fr/docs/fr/technical/i18n/panel-admin)
